...
C.create_text(500,50, text= 'Cliquer sur le bouton pour voir les mesures.', font = ('helvetica',35))
texte = C.create_text(500,300, text='Longueur = 00 cm \n\nLargeur = 00 cm \n\nHauteur = 00 cm \n\nPoids = 00 kg', font=('helvetica', 30))
C.pack()
mes_btn = Button(Mesures, text='Mesurer', command=Measures, font='helvetica')
